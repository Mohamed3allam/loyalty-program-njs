                        ...
                        <Form style={{padding:'30px'}}>
                            ...
                            <Form.Group className="mb-3">
                                <div style={{display:'flex',gap:'20px'}}>
                                    <Form.Control value={firstName} onChange={(e) => setFirstName(e.target.value)} type="text" placeholder={props.user.name.firstName ?? 'First Name'} maxLength='10'/>
                                    <Form.Control value={lastName} onChange={(e) => setLastName(e.target.value)} type="text" placeholder={props.user.name.lastName ?? 'Last Name'} maxLength='10'/>
                                </div>
                            </Form.Group>
                            <Form.Group className="mb-3">
