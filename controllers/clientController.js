...
const createToken = (_id, name, phone, log, loyalty_points, amount_spent, created_at) => {
    return jwt.sign({ _id:_id, name:name, phone:phone, log:log, loyalty_points:loyalty_points, amount_spent:amount_spent, created_at: created_at }, process.env.JWT_SECRET, { expiresIn: '7d'})
}
...
const signupClient = async (req, res) => {
    ...
    try {
        ...
        const token = createToken(client._id, client.name, client.phone, client.log, client.loyalty_points, client.amount_spent, client.created_at);
